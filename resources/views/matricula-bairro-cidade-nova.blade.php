...
<head>
    ...
    <title>Matrícula Cidade Nova Aparecida</title>
    <link rel="icon" type="image/x-icon" href="imgicon/favicon-estudandomusica.png">

    <link rel="stylesheet" type="text/css" href="css/matricula-b-cn.css">
            ...
            <form action="/matricula-bairro-aparecida-salva" method="POST">
                ...
                <div class="form-row mt-0"> 
                    <div class="col-md-12 col-sm-12">
                        ...
                        <h2>Matrícula Bairro Cidade Nova</h2>
                    </div>
                    <div class="col-md-12 col-sm-12" style="background: white; justify-content: center; display: flex;">
                    ...
                    <div class="text col-md-12 mb-0">Escolha o curso</div>
                        ...
                        <div class="form-group col-md-4 col-sm-6">
                            ...
                            <select id="horario" name="horario" class="form-control" required="required">
                                <option selected>Selecione</option>
                                <option>17:30h as 18:30h</option>
                                <option>18:30h as 19:30h</option>
                                <option>19:30h as 20:30h</option>
                            </select>
                        </div>
                        <div class="col-md-12">Local</div>
                        <div class="form-group col-md-4 col-sm-6">
                            <input type="text" id="localDoCurso" name="localDoCurso" class="form-control" placeholder="Cidade Nova">
                        </div>
